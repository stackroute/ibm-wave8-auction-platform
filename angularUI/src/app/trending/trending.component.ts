...
{
  this.auctionService.getTrendingItems().subscribe(data=>{
   // console.log(data);
   this.userData = data;
...
chunk(arr, chunkSize) {
  ...
  //   // this.getImgUrlList();
  //  this.slides = this.chunk(this.arrayOfTrendings,3);
  // }

  // getTrendingList()
  // {
  //   this.trendingService.getTrendingItems().subscribe(data=>{
  //     this.arrayOfTrendings=data
  //   });
  // }
...
// getImgUrlList()
// {
//   this.trendingService.getImgUrl().subscribe(data=>{
//     this.arrayOfTrendings=data
//   });
// }
//   cards = [
