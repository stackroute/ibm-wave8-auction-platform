...
//    private static final String TOPIC="kafkaExample6";
    ...
    @ResponseBody
    public ResponseEntity<Item> updateItem(@PathVariable Long itemId, @PathVariable double itemCurrentBid, @PathVariable int noOfDaysNeeded, @PathVariable String bidderName, @PathVariable String bidderEmailId, @PathVariable long bidderPhoneNumber){
        Item item=itemRepo.getItem(itemId);
        if(item != null){
